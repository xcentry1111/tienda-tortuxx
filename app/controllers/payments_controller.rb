class PaymentsController < ApplicationController
  ...
  def create
    ...
    if paypal_helper.process_payment.create
      ...
      raise paypal_helper.payment.error.to_yaml rescue
      redirect_to carrito_path, notice:"Hubo un error, recuerde cargar un producto para seguir con el proceso de pago"
    end
  end
end
